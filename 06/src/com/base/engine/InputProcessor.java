...
public class InputProcessor {
    ...
    private static ArrayList<Integer> arr_n_current_buttons = new ArrayList<Integer>(); // Array for currently active buttons of mouse
	...
	*/
    ...
    // Define a function to get the current key, i.e., get true if the key is pressed down
	...
	n_key_code :
	    Integer key code for the pressed key
	*/
	...
	*/
	...
	is_pressed (implicit) :
	    Whether the key is pressed or not for one frame
	*/
	...
	*/
	...
	is_pressed (implicit) :
	    Whether the key is un-pressed or not for one frame
	*/
	...
	n_mouse_button :
	    The integet code for pressed mouse button
	*/

...
public class MainGameLauncher {
	...
	// Define the constructor to build the main game launcher. The components will
	...
	public MainGameLauncher() {
		...
		// Initialize the graphics part
		RenderUtilities.InitializeGraphics();
	...
	// Define a function to pre-process and start the game launcher. The starter
	// should make the game run
	...
	// Define a function to continue the running of the game launcher. We do not
	// want it accessed by any external element
	private void RunGameLauncher() {
		...
		while (IS_GAME_WINDOW_RUNNING) {
			...
			while (d_idle_time > d_per_frame_time) {
				...
				InputProcessor.UpdateInputProcessor();
	...
	// Define a function to render the entire game launcher. We do not want it
	// accessed by any external element
	private void RenderGameLauncher() {
		...
		// First step is to clear screen
		RenderUtilities.ClearScreen();
	...
	// Define a function to cleanup after the rendering is over. As of now, only one
	// thing is needed
	...
	public static void main(String[] args) {
		...
		// Create new window
		GameWindow.CreateGameWindow(GAME_WINDOW_WIDTH, GAME_WINDOW_HEIGHT, GAME_WINDOW_TITLE); // Without the game loop,
																								// the window is
																								// instantiated and
																								// instantly destroyed.
